        ...
        <table style="width: 100%;">
            <tbody >
                <tr style="border:1px solid;">
                    ...
                    <td style="text-align: center;line-height: 15px;max-width: 200px;word-wrap: break-word;">
                        <p style="font-size: 20px;font-weight: bold;">ระเบียบการปฏิบัติงาน <br> Standard Operating Procedure (SOP)</p>
