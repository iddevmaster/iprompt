...
@section('content')
        ...
        <form class="overflow-x-auto" id="myForm" action="{{ route('preview') }}" method="POST">
            ...
            <div class="a4lan-container border mb-5 d-flex align-items-center flex-column">
                    ...
                    <div class="row border border-black mx-0  text-center" id="page-header">
                        ...
                        <div class="col pt-2">
                            @if ($class)
                                ...
                                <p class="text-start mb-1" style="font-size: 12px;">หน้าที่ 1/1</p>
                            @else
                                @php
                ...
                <div class="content py-5 w-100 h-100">
                    @if ($class)
                        <div class="editorContent" style="padding-left:1cm;padding-right:.5cm"> {!! $editorContent !!}
                        </div>
            ...
            <div class="d-flex justify-content-center ">
                ...
                @else
                    ...
                    <button type="submit" id="preview-btn" class="btn btn-success ms-2" name="submit"
    ...
    <script>
        function generateDoc(type) {
            ...
            if (type === 'company') {
                // WI-ID/ฝ่าย-0x-00-ปี
                docNo = `WI-ID/${department}-0${len}-00-${year}`;
            } else {
                // WI-ฝ่าย-0x-00-ปี
                docNo = `WI-${department}-0${len}-00-${year}`;
            }
