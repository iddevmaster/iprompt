                    ...
                    <div class="col pt-2">
                        ...
                        @else
                            ...
                            <script>
                                ...
                                document.getElementById("currentYear").innerText = "CH-ID-{{$formattedLen}}-00-"+currentYear;
                                document.getElementsByName('bookNo')[0].value = "CH-ID-{{$formattedLen}}-00-"+currentYear;
                            </script>
                        @endif
                    </div>
