            ...
            <div class="a4-container border mb-5 d-flex align-items-center flex-column">
                ...
                <div class="header">
                    ...
                    <div class="row border border-black mx-0  text-center" id="page-header">
                        ...
                        <div class="col-5 border border-black border-top-0 border-bottom-0">
                            <h5 class="mt-3 fw-bold">Check List</h5>
                            <div class="d-flex ">
                                ...
                                @else
                                    <input class="ms-2 w-100" id="subject" style="overflow-wrap: break-word;"
                        ...
                        <div class="col pt-2">
                            ...
                            @else
                                @php
                                    $dpm_prefix =
                                        strlen(Auth::user()->getDpm->prefix) > 4 ? 'ID' : Auth::user()->getDpm->prefix;
                                @endphp
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    <button type="button" class="btn btn-outline-primary w-100 mb-2"
                                        onclick="generateDoc('company')">
                                        ใช้ทั้งบริษัท
                                    </button>

                                    <button type="button" class="btn btn-outline-secondary w-100"
                                        onclick="generateDoc('department')">
                                        ใช้ภายในฝ่าย
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="row mx-0 w-100 border border-black border-top-0 justify-content-center text-center">
                        ...
                        <div
                            class="col-5 py-2 text-start align-items-start border border-black border-top-0 border-bottom-0">
                ...
                <div class="content py-4 w-100 h-100">
                    @if ($class)
                        ...
                        ?>
                        <div class="editorContent2" style="padding-left:1cm;padding-right:.5cm"> {!! $editorContent !!}
                        </div>
...
@endif
                ...
                <div class="footer mt-auto">
                    <p id="footertext">เอกสารนี้ ฉบับทางการ จะอยู่ในรูปไฟล์อิเล็กทรอนิกส์ อยู่ในระบบเครือข่ายสารสนเทศ
                        เท่านั้น หากปรากฎเอกสารนี้ส่วนหนึ่งส่วนใด หรือทั้งฉบับ
                        ในรูปสื่อกระดาษให้ตรวจสอบความทันสมัยกับฉบับทางการในระบบเครือข่ายสารสนเทศ ก่อนใช้อ้างอิง
                        และทำลายทิ้งทันที หากพบว่าเป็นฉบับไม่ทันสมัย <br>
                        เอกสารนี้ เป็น สมบัติของบริษัท ไอดีไดรฟ์ จำกัดห้ามแจกจ่ายไปยังภายนอก โดยไม่ได้รับอนุญาตจาก
                        กรรมการผู้จัดการ บริษัท ไอดีไดรฟ์ จำกัด
                    </p>
                </div> <!-- end footer -->

                <!-- send form type for preview -->
                <input type="hidden" name="formtype" id="formtype" value="checkForm">

            </div>

            @if ($class)
                @php
                    $types = App\Models\type::where('type', 'check')->get();
                @endphp
            ...
            <div class="d-flex justify-content-center ">
                ...
                @else
                    ...
                    <button type="submit" on id="preview-btn" class="btn btn-success ms-2" name="submit"
        ...
        <script>
            ...
            function generateDoc(type) {
                ...
                if (type === 'company') {
                    // CH-ID/ฝ่าย-0x-00-ปี
                    docNo = `CH-ID/${department}-0${len}-00-${year}`;
                } else {
                    // CH-ฝ่าย-0x-00-ปี
                    docNo = `CH-${department}-0${len}-00-${year}`;
                }
