                    ...
                    <div class="col pt-2">
                        ...
                        @else
                            ...
                            <script>
                                ...
                                document.getElementById("currentYear").innerText = "COS-ID-{{$formattedLen}}-00-"+currentYear;
                                document.getElementsByName('bookNo')[0].value = "COS-ID-{{$formattedLen}}-00-"+currentYear;
                            </script>
                        @endif
                    </div>
