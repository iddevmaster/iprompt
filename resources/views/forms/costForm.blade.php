...
<body onbeforeunload="return myFunction()">
    ...
    <form id="myForm" class="overflow-x-auto" action="{{ route('preview') }}" method="POST" >
        ...
        <div class="a4-container border mb-5 d-flex align-items-center flex-column">
            ...
            <div class="header">
                ...
                <div class="row border border-black mx-0  text-center" id="page-header">
                    ...
                    <div class="col-5 border border-black border-top-0 border-bottom-0">
                        <h5 class="mt-3 fw-bold">เอกสารต้นทุนงาน</h5>
                        <div class="d-flex ">
                    ...
                    <div class="col pt-2">
                        ...
                        @else
                            ...
                            <script>
                                ...
                                document.getElementById("currentYear").innerText = "CT-ID-{{$formattedLen}}-00-"+currentYear;
                                document.getElementsByName('bookNo')[0].value = "CT-ID-{{$formattedLen}}-00-"+currentYear;
                            </script>
                        @endif
                    </div>
            ...
            <input type="hidden" name="formtype" id="formtype" value="costForm">

        </div>

        @if ($class)
            @php
                $types = App\Models\type::where('type', 'cost')->get();
            @endphp
