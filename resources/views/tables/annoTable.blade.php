                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($row->files != null)
                                    ...
                                    @endforeach
                                @endif
                                <button type="button" class="btn btn-info uploadBtn" value="{{$row->id}}" fileType="announce">upload</button>
                            </td>

                            {{-- Share with person --}}
                            <td><button class="btn btn-success" id="teamBtn" value="{{ $row->submit_by}}" bookid="{{ $row->id}}" bookType="anno" teamlist="{{json_encode($teamlist)}}"
                            ...
                            @can('staff')
                                <td><button class="btn btn-success" id="shareBtn" value="{{ $row->share}}" bookid="{{ $row->id}}" fileType="anno">
                                    @php
                                        $share = $row->shares;
