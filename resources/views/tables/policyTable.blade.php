...
<body>
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <div class="p-1 ms-2 export"><a class="a-tag" href="/export/table/policyTable"><i class="bi bi-file-earmark-arrow-down"></i></a></div>
        </div>
        <!-- Table -->
                ...
                <tbody class="table-group-divider" id="tableBody">
                    ...
                    @foreach ($gendoc as $row)
                        <tr>
                            ...
                            @can('download')
                                <td>
                                    <a href="{{url('/form/downloadpol/download/'.$row->id)}}" target="_blank"><button type="button" class="btn btn-primary">Download</button></a>
                                </td>
                            @else
                                <td>
