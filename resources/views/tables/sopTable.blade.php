                ...
                <tbody class="table-group-divider" id="tableBody">
                    ...
                    @foreach ($gendoc as $row)
                        <tr>
                            ...
                            @if ((Auth::user()->id == $row->submit_by) || !(auth()->user()->can('staff')))
                                <td>
                                    <a href="{{url('/form/downloadsop/download/'.$row->id)}}" target="_blank"><button type="button" class="btn btn-primary">Download</button></a>
                                </td>
                            @else
                                <td>
                                    <a href="{{url('/form/downloadsop/download/'.$row->id)}}" target="_blank"><button type="button" class="btn btn-primary">View</button></a>
                                </td>
                            @endif
                            @endcan
