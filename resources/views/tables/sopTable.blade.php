                    ...
                    @foreach ($gendoc as $row)
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    if (is_array($usarr)) {
                                        ...
                                        echo ($submitUser ? $submitUser->name : 'Unknown') . '/' .$row->dpm ?? 'Unknown';
                                    } else {
                            ...
                            @if ((((App\Models\department::find((Auth::user())->dpm))->prefix) == $row->dpm || Auth::user()->hasRole(['admin', 'ceo'])) || (auth()->user()->can('download')) || (in_array((Auth::user())->dpm, $shares)))
                                <td>
                                    <a href="{{url('/form/downloadsop/download/'.$encryptedId)}}" target="_blank"><button type="button" class="btn btn-primary">Download</button></a>
                                </td>
                            @else
                                <td>
                                    <a href="{{url('/form/downloadsop/view/'.$encryptedId)}}" target="_blank"><button type="button" class="btn btn-primary">View</button></a>
                                </td>
                            @endif
                            ...
                            {{-- Share with person --}}
                            <td><button class="btn btn-success" id="teamBtn" value="{{ $row->submit_by}}" bookid="{{ $row->id}}" bookType="sop" teamlist="{{json_encode($teamlist)}}"
